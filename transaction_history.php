...
// Fetch transaction history from the deposit table
$queryDeposits = "SELECT name, account_number, account_type, transaction_type, created_at, deposited_amount FROM deposit";
...
$queryTransactions = "SELECT sender_account, recipient_account, amount, transaction_type, created_at FROM transactions";
...
<body>
    <div class="container mt-5">
        <h2>Transactions Made In Different Banks</h2>
        <table class="table table-bordered mt-4">
            <thead>
                <tr>
                    <th>Name/Account</th>
